...
| --- | ---: | ---: | ---: | ---: |
| Python modules | 3 | 64 | 12 | 76 |
| Physical Python lines | 12,671 | 14,054 | 3,347 | 17,401 |
...
- Strict schemas: **23**, including **1** release-spec schema.
- Metadata history: **7 keys**, **19 states**, **10 versions**, **9 transitions**.
- Regression test methods: **253**.
- Combined source digest: `1f9fe2c24fb4b88fed883b2dba624f26ba7992a1974d666449bb6606c2b97ec2`.
