...
| --- | ---: | ---: | ---: | ---: |
| Python modules | 3 | 62 | 12 | 74 |
| Physical Python lines | 12,671 | 13,390 | 3,347 | 16,737 |
...
- Source registry entries: **131** (16 required, 115 optional).
- Strict schemas: **21**, including **1** release-spec schema.
- Metadata history: **7 keys**, **19 states**, **10 versions**, **9 transitions**.
- Regression test methods: **243**.
- Combined source digest: `2a19af0b392058f9c5f8904f62a272703712cc049687b5f76d36542f11dca64b`.
